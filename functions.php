...
//custom functions and post type

function weed_strain(){
	$labels = array(
		'name'				=> ('strains'),
		'singular_name' 	=> ('strain'),
		'menu_name'			=> ('Weed Strains'),
	);
	$args = array(
		'label'				=> ('strains'),
		'description'		=> ('Weed strains'),
		'labels'			=> $labels,
		'supports'			=> array(
			'title',
			'editor',
...
add_action('init','weed_strain', 0);

//add shortcode

function strain_shortcode(){
    ...
    if($query->have_posts()) :
        ...
        $result .= '<div class="strain-item">';
        $result .= '<div class="strain-img">' . get_the_post_thumbnail() . '</div>';
        $result .= '<h3 class="strain-name">' . get_the_title() . '</h3>';
        $result .= '<div class="strain-cont">' . get_the_content() . '</div>'; 
        $result .= '</div>';
